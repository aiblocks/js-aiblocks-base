 ...
 * @param {string} [opts.networkPassphrase] passphrase of the target stellar network (e.g. "Public Global AiBlocks Network ; December 2020").
 */
export class TransactionBuilder {
   ...
   *
   * @param {string} [networkPassphrase] passphrase of the target stellar network (e.g. "Public Global AiBlocks Network ; December 2020").
   * @returns {TransactionBuilder}
   */
   ...
   * @param {string} networkPassphrase - networkPassphrase of the target stellar network (e.g. "Public Global AiBlocks Network ; December 2020").
